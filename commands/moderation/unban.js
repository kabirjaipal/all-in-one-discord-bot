    ...
    run: async (client, message, args) => {
        ...
        if (!message.member.permissions.has("BAN_MEMBERS")) return message.channel.send(
            new MessageEmbed()
                ...
                .setDescription("**You Dont Have The Permissions To UNBAN Users! - [BAN_MEMBERS]**")
        ...
        if (!message.guild.me.permissions.has('BAN_MEMBERS')) return message.channel.send(
            new MessageEmbed()
                .setColor("RED")
                .setAuthor(message.author.tag)
                .setDescription("**You Dont Have The Permissions To UNBAN Users! - [BAN_MEMBERS]**")
        ...
        let Sembed = new MessageEmbed()
            .setColor("RED")
            .setAuthor(message.author.tag)
            .setDescription(`> You've been unbanned from **${message.guild.name}** because of ${reason}. You are permanently Unbanned.`)
            .setFooter("Coded by: Tech Boy Gaming")
