        ...
        message.channel.send(
            ...
            msg.edit(
                new MessageEmbed()
                    ...
                    .addField('**❯ Avatar:**', `[\`Link to avatar\`](${user.user.displayAvatarURL({ format: "png" })})`, true)
                    .addField('**❯ Bot:**', `\`${user.user.bot ? 'Yes' : 'No'}\``, true)
                    .addField('**❯ Date Joined DC:**', `\`${moment(user.user.createdTimestamp).format('LT')} ${moment(user.user.createdTimestamp).format('LL')}   ${moment(user.user.createdTimestamp).fromNow()}\``, true)
                    .addField('**❯ Date Joined Server:**', `\`${moment(user.joinedAt).format('LL LTS')}\``, true)
                    .addField('**❯ Messages Count:**', `\`${messagecount}\`
